...
| [`2026-09-13-checkin-gate-recharge-fallback.md`](2026-09-13-checkin-gate-recharge-fallback.md) | （被取代）签到 min_spend 曾回退 `users.total_recharged` |
| [`2026-09-14-checkin-gate-paid-orders.md`](2026-09-14-checkin-gate-paid-orders.md) | 签到 min_spend 取用量实际扣除与已完成实付（余额+订阅）的较高值 |

...
| [`features/subscription-credit-pool.md`](features/subscription-credit-pool.md) | 用户级订阅额度池:额度优先消费、不足拆分扣余额、ledger 审计与上限通知 |
...
| [`features/model-market.md`](features/model-market.md) | 公共模型广场页面与后台配置:按平台 / 分组 / 计费类型展示可用模型 |

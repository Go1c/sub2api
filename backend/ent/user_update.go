...
func (_u *UserUpdate) SetSubscriptionPurchaseDisabled(v bool) *UserUpdate {
	_u.mutation.SetSubscriptionPurchaseDisabled(v)
	return _u
}

// SetNillableSubscriptionPurchaseDisabled sets the "subscription_purchase_disabled" field if the given value is not nil.
func (_u *UserUpdate) SetNillableSubscriptionPurchaseDisabled(v *bool) *UserUpdate {
	if v != nil {
		_u.SetSubscriptionPurchaseDisabled(*v)
	}
	return _u
}
...
func (_u *UserUpdate) AddSubscriptionCreditLedgerIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) AddSubscriptionCreditLedgers(v ...*SubscriptionCreditLedger) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) ClearSubscriptionCreditLedgers() *UserUpdate {
...
func (_u *UserUpdate) RemoveSubscriptionCreditLedgerIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) RemoveSubscriptionCreditLedgers(v ...*SubscriptionCreditLedger) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.SubscriptionPurchaseDisabled(); ok {
...
// SetSubscriptionPurchaseDisabled sets the "subscription_purchase_disabled" field.
func (_u *UserUpdateOne) SetSubscriptionPurchaseDisabled(v bool) *UserUpdateOne {
	_u.mutation.SetSubscriptionPurchaseDisabled(v)
	return _u
}

// SetNillableSubscriptionPurchaseDisabled sets the "subscription_purchase_disabled" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableSubscriptionPurchaseDisabled(v *bool) *UserUpdateOne {
	if v != nil {
		_u.SetSubscriptionPurchaseDisabled(*v)
	}
	return _u
...
// AddSubscriptionCreditLedgerIDs adds the "subscription_credit_ledgers" edge to the SubscriptionCreditLedger entity by IDs.
func (_u *UserUpdateOne) AddSubscriptionCreditLedgerIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddSubscriptionCreditLedgerIDs(ids...)
	return _u
}

// AddSubscriptionCreditLedgers adds the "subscription_credit_ledgers" edges to the SubscriptionCreditLedger entity.
func (_u *UserUpdateOne) AddSubscriptionCreditLedgers(v ...*SubscriptionCreditLedger) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSubscriptionCreditLedgers clears all "subscription_credit_ledgers" edges to the SubscriptionCreditLedger entity.
func (_u *UserUpdateOne) ClearSubscriptionCreditLedgers() *UserUpdateOne {
	_u.mutation.ClearSubscriptionCreditLedgers()
	return _u
}

// RemoveSubscriptionCreditLedgerIDs removes the "subscription_credit_ledgers" edge to SubscriptionCreditLedger entities by IDs.
func (_u *UserUpdateOne) RemoveSubscriptionCreditLedgerIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveSubscriptionCreditLedgerIDs(ids...)
	return _u
}

// RemoveSubscriptionCreditLedgers removes "subscription_credit_ledgers" edges to SubscriptionCreditLedger entities.
func (_u *UserUpdateOne) RemoveSubscriptionCreditLedgers(v ...*SubscriptionCreditLedger) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}

...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldBalance, user.FieldBalanceNotifyThreshold, user.FieldWebsocketBalanceAlertThreshold, user.FieldWebhookBalanceNotifyThreshold, user.FieldTotalRecharged:

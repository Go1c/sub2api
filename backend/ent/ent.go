...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			accounterrorhistory.Table:            accounterrorhistory.ValidColumn,
			accountgroup.Table:                   accountgroup.ValidColumn,
			announcement.Table:                   announcement.ValidColumn,
			announcementread.Table:               announcementread.ValidColumn,
			authidentity.Table:                   authidentity.ValidColumn,
			authidentitychannel.Table:            authidentitychannel.ValidColumn,
			balancecacheinvalidationoutbox.Table: balancecacheinvalidationoutbox.ValidColumn,
			balancedebitclient.Table:             balancedebitclient.ValidColumn,
			balancedebittransaction.Table:        balancedebittransaction.ValidColumn,
			...
			lotterycode.Table:                    lotterycode.ValidColumn,
			...
			subscriptioncreditledger.Table:       subscriptioncreditledger.ValidColumn,

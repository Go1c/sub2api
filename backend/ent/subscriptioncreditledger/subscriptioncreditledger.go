...
const (
	// Label holds the string label denoting the subscriptioncreditledger type in the database.
	Label = "subscription_credit_ledger"
	...
	// FieldBalanceDeltaUsd holds the string denoting the balance_delta_usd field in the database.
	FieldBalanceDeltaUsd = "balance_delta_usd"
	// FieldRemainingAfterUsd holds the string denoting the remaining_after_usd field in the database.
	FieldRemainingAfterUsd = "remaining_after_usd"
	...
	EdgeOrder = "order"
	// Table holds the table name of the subscriptioncreditledger in the database.
	Table = "subscription_credit_ledger"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "subscription_credit_ledger"
	...
	SubscriptionTable = "subscription_credit_ledger"
	...
	GroupTable = "subscription_credit_ledger"
	...
	APIKeyTable = "subscription_credit_ledger"
	...
	UsageLogTable = "subscription_credit_ledger"
	...
	OrderTable = "subscription_credit_ledger"
...
// Columns holds all SQL columns for subscriptioncreditledger fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldSubscriptionID,
	...
	FieldType,
	FieldDeltaUsd,
	FieldBalanceDeltaUsd,
	FieldRemainingAfterUsd,
	FieldReason,
	FieldEventKey,
	FieldMetadata,
	FieldCreatedAt,
...
var (
	...
	// DefaultBalanceDeltaUsd holds the default value on creation for the "balance_delta_usd" field.
	DefaultBalanceDeltaUsd float64
...
// OrderOption defines the ordering options for the SubscriptionCreditLedger queries.
...
// ByBalanceDeltaUsd orders the results by the balance_delta_usd field.
func ByBalanceDeltaUsd(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldBalanceDeltaUsd, opts...).ToFunc()
}

// ByRemainingAfterUsd orders the results by the remaining_after_usd field.
func ByRemainingAfterUsd(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldRemainingAfterUsd, opts...).ToFunc()
}

...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.PendingAuthSession, c.PromoCode, c.PromoCodeUsage, c.Proxy, c.ProxyIPGroup,
		c.RedeemCode, c.SecuritySecret, c.Setting, c.SiteMessage,
...
type (
	hooks struct {
		...
		ProxyIPGroup, RedeemCode, SecuritySecret, Setting, SiteMessage,
		SubscriptionCreditLedger, SubscriptionPlan, TLSFingerprintProfile,

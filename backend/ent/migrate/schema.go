...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "web_search_rate_independent", Type: field.TypeBool, Default: false},
		{Name: "web_search_rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "webhook_site_message_notify_enabled", Type: field.TypeBool, Default: true},

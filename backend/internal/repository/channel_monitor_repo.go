...
// channelMonitorHeadersForPersistence injects the internal duplicate operation
// metadata into extra_headers for storage, while keeping service-layer
// ExtraHeaders free of that key.

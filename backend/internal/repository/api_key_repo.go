	...
	m, err := r.activeQuery().
		...
		WithUser(func(q *dbent.UserQuery) {
			q.Select(
				...
				user.FieldWebhookSiteMessageNotifyEnabled,
				user.FieldWebhookAnnouncementNotifyEnabled,
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldWebSearchRateIndependent,
				group.FieldWebSearchRateMultiplier,

...
func registerOpsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	ops := admin.Group("/ops")
	{
		...
		// Account error Telegram alert config (DB-backed)
		ops.GET("/account-error-alert/config", h.Admin.Ops.GetAccountErrorAlertConfig)
		ops.PUT("/account-error-alert/config", h.Admin.Ops.UpdateAccountErrorAlertConfig)
...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.GET("/:id/wallet-debits", h.Admin.User.GetUserWalletDebits)
...
func registerSiteMessageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	siteMessages := admin.Group("/site-messages")
	{
		...
		siteMessages.GET("/compensation-batches", h.Admin.SiteMessage.ListCompensationBatches)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/request-health/batch", h.Admin.Account.GetBatchRequestHealth)
...
func registerSubscriptionRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	subscriptions := admin.Group("/subscriptions")
	{
		...
		subscriptions.GET("/waste-stats", h.Admin.SubscriptionWasteStats.Get)
		subscriptions.GET("/waste-stats/by-plan", h.Admin.SubscriptionWasteStats.GetByPlan)
		subscriptions.GET("/waste-stats/time-series", h.Admin.SubscriptionWasteStats.GetTimeSeries)
		subscriptions.GET("/:id/ledger", h.Admin.Subscription.GetLedger)
		subscriptions.GET("/:id", h.Admin.Subscription.GetByID)
		subscriptions.GET("/:id/progress", h.Admin.Subscription.GetProgress)
		subscriptions.PATCH("/:id", h.Admin.Subscription.Update)
...
func registerAffiliateRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	...
	{
		affiliates.GET("/invite-logs", h.Admin.Affiliate.ListInviteLogs)

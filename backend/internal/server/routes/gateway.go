...
func RegisterGatewayRoutes(
	...
	// Basis Points fetches these temporary images without the client's API key.
	// There is no public upload route; only an enabled relay creates them.
	r.GET("/api/bps-images/:token", h.OpenAIGateway.BasisPointsImage)
	r.HEAD("/api/bps-images/:token", h.OpenAIGateway.BasisPointsImage)

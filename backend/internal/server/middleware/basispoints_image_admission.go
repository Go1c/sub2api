...
type excelBPSImageSettingsReader interface {
	GetBasisPointsImageRelaySettings(context.Context) (service.BasisPointsImageRelaySettings, error)
}
...
func ExcelBPSImageAdmission(settings excelBPSImageSettingsReader, configuredMax int64) gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		relay, err := settings.GetBasisPointsImageRelaySettings(c.Request.Context())
		if err != nil {

	...
	}{
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"webhook_balance_notify_enabled": false,
					"webhook_balance_notify_url": "",
					"webhook_balance_notify_threshold": null,
					"webhook_site_message_notify_enabled": false,
...
func newContractDeps(t *testing.T) *contractDeps {
	...
	adminService := service.NewAdminService(userRepo, groupRepo, &accountRepo, proxyRepo, nil, apiKeyRepo, redeemRepo, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func (stubGroupRepo) CountExhaustedFallbackReferers(ctx context.Context, groupID int64) (int64, error) {
	return 0, nil
}
...
// SubscriptionCreditExtension stubs（契约测试用 legacy 路径，默认 not found / not implemented）
...
func (stubUserSubscriptionRepo) ExpireCreditSubscriptions(ctx context.Context) (int64, error) {
	return 0, errors.New("not implemented")
}

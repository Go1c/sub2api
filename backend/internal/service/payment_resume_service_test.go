...
func TestNormalizeVisibleMethodSource(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "alipay mapay alias", method: payment.TypeAlipay, input: "mapay", want: VisibleMethodSourceMapayAlipay},
		...
		{name: "wxpay mapay alias", method: payment.TypeWxpay, input: "mapay", want: VisibleMethodSourceMapayWechat},
...
func TestVisibleMethodProviderKeyForSource(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "mapay alipay", method: payment.TypeAlipay, source: VisibleMethodSourceMapayAlipay, want: payment.TypeMapay, ok: true},
		...
		{name: "mapay wechat", method: payment.TypeWxpay, source: VisibleMethodSourceMapayWechat, want: payment.TypeMapay, ok: true},

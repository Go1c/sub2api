...
func mergeBalanceHistoryCodes(redeemCodes, affiliateCodes, externalCodes []RedeemCode, params pagination.PaginationParams) []RedeemCode {
	combined := append(append(append([]RedeemCode{}, redeemCodes...), affiliateCodes...), externalCodes...)

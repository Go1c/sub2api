...
func TestGroupResolveMessagesDispatchModel_GrokMapsClaudeFamilyToGrok(t *testing.T) {
	...
	require.Equal(t, "grok-4.6", group.ResolveMessagesDispatchModel("claude-sonnet-4-5"))
	require.Equal(t, "grok-4.6", group.ResolveMessagesDispatchModel("claude-opus-4-6"))
	require.Equal(t, "grok-4.6", group.ResolveMessagesDispatchModel("claude-haiku-4-5"))
...
func TestSanitizeGroupMessagesDispatchFields_KeepsCompositeAllowMessagesDispatch(t *testing.T) {
	t.Parallel()

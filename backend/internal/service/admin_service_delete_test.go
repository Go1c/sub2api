...
func (s *userRepoStub) BatchUpdateLimits(context.Context, []int64, *int, *int) (int, error) { return 0, nil }
...
func (s *groupRepoStub) CountExhaustedFallbackReferers(context.Context, int64) (int64, error) {
	return 0, nil
}

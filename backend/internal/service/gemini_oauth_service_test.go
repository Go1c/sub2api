...
func (m *mockGeminiProxyRepo) SweepExpiredProxies(context.Context, time.Time) (int64, error) { return 0, nil }
...
func (m *mockGeminiProxyRepo) CountExpiringSoon(context.Context, time.Time) (int64, error) { return 0, nil }

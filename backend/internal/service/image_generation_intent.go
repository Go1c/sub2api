...
// 不检测被动的 image_gen namespace 声明。用于 capability / 权限门控——被动 namespace 不应
// 强制要求原生 Responses 能力，也不应在禁生图分组里对所有 Codex 请求 403（#4447 / #4476）。
...
// openAIJSONToolsContainNativeImageGeneration only matches the hosted
// image_generation tool type. Namespace catalogs alone are ignored.

...
func TestAliasOpenAIOAuthReservedToolNames_FunctionsAndFunctionCallRunBeforeAlias(t *testing.T) {
	body := []byte(`{"model":"gpt-5.5","input":[{"type":"function_call","name":"python","call_id":"fc_1"}],"functions":[{"name":"python"}],"function_call":{"name":"python"},"sequence":900719925474099312345}`)

...
func TestOpenAIGatewayForwardUsesGlobalCompactModelOnInitialLegacyRequest(t *testing.T) {
	...
	// Fork only rewrites the initial compact model via account compact_model_mapping.
	// The process-wide OpenAICompactModel is the same-account retry fallback, not
	// an automatic first-attempt rewrite.

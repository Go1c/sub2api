...
func (s *authRepoStub) GetByUserIDAndName(ctx context.Context, userID int64, name string) (*APIKey, error) {
	panic("unexpected GetByUserIDAndName call")
}
...
func (s *authRepoStub) DeleteWithAudit(context.Context, int64) error {
	panic("unexpected")
}

...
// OpenAIAPIKeyHealthCache counts rolling failures for pool-mode OpenAI API keys.
type OpenAIAPIKeyHealthCache interface {
	RecordOpenAIAPIKeyHealthFailure(ctx context.Context, accountID int64, windowMinutes, threshold int) (int64, bool, error)
}

...
var pendingOrderStatuses = []string{
	...
	payment.OrderStatusFulfillmentFailed,
}
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeMapay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true,
}

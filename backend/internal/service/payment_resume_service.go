...
func NormalizeVisibleMethodSource(method, source string) string {
	...
	case payment.TypeAlipay:
		...
		case VisibleMethodSourceMapayAlipay, payment.TypeMapay:
			return VisibleMethodSourceMapayAlipay
		}
	case payment.TypeWxpay:
		...
		case VisibleMethodSourceMapayWechat, payment.TypeMapay:
			return VisibleMethodSourceMapayWechat
		}
	}
	return ""
}
...
func VisibleMethodProviderKeyForSource(method, source string) (string, bool) {
	...
	case VisibleMethodSourceMapayAlipay:
		return payment.TypeMapay, NormalizeVisibleMethod(method) == payment.TypeAlipay
	...
	case VisibleMethodSourceMapayWechat:
		return payment.TypeMapay, NormalizeVisibleMethod(method) == payment.TypeWxpay
	default:
		return "", false
	}
}

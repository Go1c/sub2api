...
// SetOpenAIGatewayService injects the OpenAI-compatible gateway service for key billing resolution.
func (h *GatewayHandler) SetOpenAIGatewayService(svc *service.OpenAIGatewayService) {
	if h == nil {
		return
	}

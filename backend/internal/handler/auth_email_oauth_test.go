...
func (r *oauthEmailAffiliateRepoStub) BindInviterWithSignupBonus(_ context.Context, req service.AffiliateSignupBonusRequest) (*service.AffiliateSignupBonusResult, error) {
	r.bindCalls = append(r.bindCalls, oauthEmailAffiliateBindCall{userID: req.UserID, inviterID: req.InviterID})
	return &service.AffiliateSignupBonusResult{Bound: true}, nil
}

func (r *oauthEmailAffiliateRepoStub) RecordInviteLog(context.Context, service.AffiliateInviteLogEntry) error {
	panic("unexpected RecordInviteLog call")
}

func (r *oauthEmailAffiliateRepoStub) ListInviteLogs(context.Context, service.AffiliateInviteLogFilter) ([]service.AffiliateInviteLog, int64, error) {
	panic("unexpected ListInviteLogs call")
}
...
func (r *oauthEmailAffiliateRepoStub) GetInviteeRechargeTotal(context.Context, int64) (float64, error) {
	panic("unexpected GetInviteeRechargeTotal call")
}

...
// TestUserPlatformQuotasCNProvidersMigration 校验 934 号迁移把 kimi/zhipu/deepseek
// 加入 user_platform_quotas.platform 的 CHECK 约束（对照 901 号 grok 迁移）。
...
func TestUserPlatformQuotasCNProvidersMigration(t *testing.T) {
	content, err := FS.ReadFile("934_user_platform_quotas_add_cn_providers.sql")

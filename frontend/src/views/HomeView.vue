...
const zhCopy: HomeCopy = {
  ...
  regionTitleLead: '本服务',
  regionTitleAccent: '面向全球，包括中国大陆',
  regionTitleEnd: '',
  regionSubtitle: 'Available worldwide, including Mainland China',
  regionBody: '本服务由美国公司 Lumio Games LLC 运营，服务器位于美国、受美国法律保护。本服务面向全球，包括中国大陆。位于中国大陆地区的用户、通常居住于中国大陆地区的用户，以及中国大陆注册或经营的实体，可以访问、注册、充值并调用 API，具体以服务条款和适用法律为准。',
  regionBodyEn: 'Operated by Lumio Games LLC (United States). This service is available worldwide, including Mainland China.',
  regionCta: '查看完整声明 →',
  supportTitle: '技术支持',
...
const enCopy: HomeCopy = {
  ...
  regionTitleAccent: 'available worldwide',
  regionTitleEnd: ', including Mainland China',
  regionSubtitle: 'Available worldwide, including Mainland China',
  regionBody: 'This service is operated by Lumio Games LLC (United States), with servers located in the United States and protected under U.S. law. It is available worldwide, including Mainland China. Users located or ordinarily resident in Mainland China, and entities registered or operating there, may access, register, add funds, and use the API, subject to the Terms of Service and applicable law.',
  regionBodyEn: 'Operated by Lumio Games LLC (United States). This service is available worldwide, including Mainland China.',

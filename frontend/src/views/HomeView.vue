...
const zhCopy: HomeCopy = {
  ...
  regionTitleLead: '本服务',
  regionTitleAccent: '面向全球包括中国大陆',
  regionTitleEnd: '开放',
  regionSubtitle: 'Available worldwide, including Mainland China',
  regionBody: '本服务由美国公司 Lumio Games LLC 运营，服务器位于美国、受美国法律保护。面向全球，包括中国大陆。大陆用户和主体可以注册、充值并调用 API，具体以服务条款和适用法律为准。',
  regionBodyEn: 'Operated by Lumio Games LLC (United States). Available worldwide, including Mainland China, subject to the Terms of Service and applicable law.',
  regionCta: '查看完整声明 →',
  supportTitle: '技术支持',
...
const enCopy: HomeCopy = {
  ...
  regionSubtitle: 'Available worldwide, including Mainland China',
  regionBody: 'This service is operated by Lumio Games LLC (United States), with servers located in the United States and protected under U.S. law. It is available worldwide, including Mainland China. Users and entities in Mainland China may register, add credit, and call the API, subject to the Terms of Service and applicable law.',
  regionBodyEn: 'Operated by Lumio Games LLC (United States). Available worldwide, including Mainland China, subject to the Terms of Service and applicable law.',

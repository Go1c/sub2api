...
const typeOptions = computed(() => [
  ...
  { value: 'balance_payment', label: t('admin.users.typeBalancePayment') },
...
const isBalanceType = (type: string) => type === 'balance' || type === 'balance_payment' || type === 'admin_balance' || type === 'affiliate_balance'

export default {
  ...
  profile: {
    ...
    webhookNotify: {
      title: 'Webhook',
      description: '余额低于阈值、收到站内信或公告时，向你配置的 Webhook 地址发送通知（无需保持网页打开）',
      enabled: '启用 Webhook',
      webhookUrl: 'Webhook 地址',
      webhookUrlHint: '仅支持 https 地址',
      webhookUrlPlaceholder: 'https://example.com/hooks/xxx',
      balanceAlert: '余额低于阈值时通知',
      balanceAlertHint: '扣费导致余额首次跌破阈值时发送',
      alwaysOnWithMaster: '随总开关启用',
      threshold: '余额告警阈值',
      thresholdHint: '留空使用默认 $10',
      thresholdPlaceholder: '默认 10',
      siteMessage: '收到站内信时通知',
      siteMessageHint: '收件箱有新消息时发送',
      announcement: '收到公告时通知',
      announcementHint: '有新的可见公告时发送',
      test: '发送测试',
      testing: '发送中…',

export default {
  ...
  nav: {
    ...
    affiliateSignupBonusRecords: '注册赠送记录',
  ...
  usage: {
    ...
    type: '类型',
    deductionMode: '扣费方式',
    deductionModeBalance: '余额',
    deductionModeSubscription: '订阅',
  ...
  redeem: {
    title: '兑换码',
    description: '输入兑换码或优惠码以充值余额、增加并发数或领取赠送余额',
    currentBalance: '当前余额',
    concurrency: '并发数',
    requests: '请求',
    redeemCodeLabel: '兑换码 / 优惠码',
    redeemCodePlaceholder: '请输入兑换码或优惠码',
    redeemCodeHint: '兑换码区分大小写；优惠码受使用次数限制',
    redeeming: '兑换中...',
    redeemButton: '兑换',
    redeemSuccess: '兑换成功！',
    redeemFailed: '兑换失败',
    ...
    newConcurrency: '新并发数',
    aboutCodes: '关于兑换',
    codeRule1: '兑换码只能使用一次；优惠码按后台设置的次数上限使用',
    codeRule2: '兑换码可以增加余额、并发数或试用权限；优惠码会增加赠送余额',
    ...
    failedToRedeem: '兑换失败，请检查兑换码或优惠码后重试。',
    subscriptionRefreshFailed: '兑换成功，但订阅状态刷新失败。',
    pleaseEnterCode: '请输入兑换码或优惠码'
  },
  ...
  profile: {
    ...
    websocketNotify: {
      title: 'WebSocket 设置',
      description: '启用后，在打开本站任意页面时可收到实时提醒（与邮件余额提醒相互独立）',
      enabled: '启用 WebSocket',
      balanceAlert: '余额低于阈值时通知',
      balanceAlertHint: '扣费导致余额首次跌破阈值时，向当前网页推送提醒',
      balanceThreshold: '余额告警阈值',
      balanceThresholdHint: '留空使用默认 $10',
      balanceThresholdPlaceholder: '默认 10',
      siteMessage: '收到站内信时通知',
      siteMessageHint: '收件箱有新消息时实时提醒',
      announcement: '收到公告时通知',
      announcementHint: '有新的可见公告时实时提醒',
      test: '发送测试',
      testing: '发送中…',
      testHint: '请先启用并保持本站页面打开',
      testSent: '测试通知已发送',
      testFailed: '测试失败',
      saved: '已保存',
      saveFailed: '保存失败'
  ...
  admin: {
    ...
    dashboard: {
      ...
      totalUsers: '用户总数',
      activeUsers: '活跃用户',
      totalUserBalance: '用户余额总数',
      balanceRankingTop20: '余额排行榜 Top 20',
      balanceUserCount: '共 {count} 个用户',
      balanceUnit: '单位：美元账户额度',
      rank: '排名',
      accounts: '账号',
      totalAccounts: '账号总数',
      activeAccounts: '活跃账号',
    ...
    affiliates: {
      ...
      signupBonusesDescription: '查看邀请注册赠送的发放结果、拒绝原因和风控信息',
    ...
    invoice: {
      title: '开票记录',
      description: '查看全站发票申请，上传发票并完成邮件发送',
      searchPlaceholder: '搜索申请单号、邮箱、抬头或税号',
      userId: '用户 ID',
      user: '用户',
      userCompletedInvoiceAmount: '历史开票金额',
      userTotalRecharged: '历史充值金额',
      taxAmount: '税点扣除',
      complete: '完成开票',
      fail: '标记失败',
      completeTitle: '完成开票',
      file: '发票文件',
      taxRate: '税点比例',
      taxRateHint: '默认 0.01，即 1%。完成后按发票金额乘以该比例扣除用户余额。',
      failTitle: '标记开票失败',
      failReasonPlaceholder: '请输入失败原因',
      failedToLoad: '加载开票记录失败',
      fileRequired: '请先选择发票文件',
    ...
    groups: {
      ...
      videoPricing: {
        ...
        modeHint: '视频按秒计费：每秒价格 × 时长（1-15 秒，未指定默认 8 秒），再叠加分组有效倍率或视频独立倍率。',
      ...
      exhaustedAccountsFallback: {
        title: '账号不可用时兜底分组',
        hint: '当前分组账号报错或不可用（限流/模型容量耗尽等）且响应尚未开始写出时，自动切换到此分组重试。兜底分组必须是同平台、未配置链式兜底的活跃分组。留空表示不兜底',
        noFallback: '不兜底'
      },
      copyAccounts: {
        title: '从分组复制账号',
    ...
    riskControl: {
      ...
      retryCount: '失败重试次数',
      sampleRate: '采样率',
      scoreThreshold: '命中分数阈值',
      scoreThresholdPlaceholder: '留空使用默认分类阈值',
      scoreThresholdHint: '填写 1-100 后，所有分类达到该百分比即视为命中；留空则使用系统内置分类阈值。',
    ...
    accounts: {
      ...
      upstreamBalance: {
        ...
        loginUsername: '上游账号',
        loginPassword: '上游密码',
        loginPasswordPlaceholder: '仅本次请求使用',
        loginButton: '获取余额凭据',
        loginLoading: '获取中...',
        loginHint: '先选择站点类型。NewAPI/Sub2API 支持账号密码换取余额凭据，其他类型只走通用余额探测。',
        loginMissingFields: '请填写上游地址、账号和密码',
        loginUnsupportedProvider: '其他类型不支持账号密码获取凭据，请选择 NewAPI 或 Sub2API',
        loginSuccess: '已获取上游余额凭据',
        loginFailed: '获取上游余额凭据失败',
        newApiAccessToken: '用户 Token / Cookie',
        newApiAccessTokenHint: '可选。可手动填写，或用上方账号密码自动获取；留空则保留已保存的凭据。',
        newApiUserId: '上游用户 ID',
        newApiUserIdHint: '可选。NewAPI 需要和用户凭据一起使用；Sub2API 会自动回填。',
        success: '请求成功',
        failed: '请求失败'
      },
      ...
      openai: {
        ...
        imageRouting: '图片请求路由',
        imageRoutingDesc:
          '账号级策略，直接控制当前 OpenAI 账号是否参与图片请求路由。适用于显式 image_generation 工具、MCP 生图工具和独立图片生成接口，不依赖全局环境变量。',
        imageRoutingMixed: '文本与图片',
        imageRoutingMixedDesc: '默认兼容模式，文本请求和图片请求都可以路由到当前账号。',
        imageRoutingTextOnly: '仅文本',
        imageRoutingTextOnlyDesc: '当前账号只处理文本请求；显式生图与 MCP 生图会跳过它。',
        imageRoutingImageOnly: '仅图片',
        imageRoutingImageOnlyDesc: '当前账号只处理图片请求；普通文本 /responses 不会路由到它。',
        imageRoutingBadgeMixed: '混合',
        imageRoutingBadgeTextOnly: '仅文本',
        imageRoutingBadgeImageOnly: '仅图片',
        codexImageGenerationBridge: 'Codex 图片生成桥接',
        codexImageGenerationBridgeDesc:
          '仅控制 Codex 走 /responses 文本端点时是否自动注入 image_generation 工具；不控制账号 A/B 的图片请求分流。',
    ...
    siteMessageManagement: {
      title: '站内信管理',
      description: '管理员查看历史补偿并发送站内信，可附加补偿码',
      money: '{amount} 元',
      tabs: {
        history: '历史补偿',
        new: '新增补偿'
      ...
      composeTitle: '发送站内信',
      composeSubtitle: '选择收件范围、填写标题内容，并决定是否附带补偿码。',
      previewBadge: '管理员功能',
      recipientMode: '收件范围',
      mode: {
        selected: '指定邮箱用户',
        selectedDescription: '粘贴邮箱列表，只发送给这些用户。',
        all: '全员站内信',
        allDescription: '发送给所有注册用户。正式发送前建议再次确认。'
      },
      recipientList: '邮箱列表',
      clear: '清空',
      recipientPlaceholder: '每行一个邮箱，也可以用逗号、空格或分号分隔',
      parsedRecipients: '已识别 {count} 个邮箱',
      invalidRecipients: '{count} 个格式异常',
      recipientFilter: '全员筛选',
      filter: {
        all: '全部活跃用户',
        allDescription: '发送给所有状态正常的注册用户。',
        inactive: '最近未使用用户',
        inactiveDescription: '只发送给最近 N 天没有 API 使用记录的活跃用户。'
      },
      inactiveDays: '未使用天数',
      inactiveDaysHint: '按 usage logs 判断；从未使用过服务的用户也会包含。',
      subject: '标题',
      subjectPlaceholder: '例如：服务维护补偿通知',
      content: '内容',
      contentPlaceholder: '输入站内信正文。开启补偿后，补偿码会追加在正文末尾。',
      sendEmail: '同时发送到用户邮箱',
      sendEmailHint: '使用已配置的 SMTP 为每位收件人发送一封邮件副本。',
      compensation: '是否发放补偿',
      compensationHint: '可使用「兑换码」管理生成的余额兑换码，或使用「优惠码」管理中的优惠码；余额在用户兑换时入账。',
      compensationAmount: '补偿额度',
      compensationAmountHint: '用于展示和校验，应与余额兑换码面值或优惠码赠送余额一致。',
      compensationFormat: '追加格式',
      generatedCodes: '补偿码',
      openRedeemManagement: '打开兑换码管理',
      openPromoManagement: '打开优惠码管理',
      generatedCodesPlaceholder: '粘贴余额兑换码或优惠码；余额兑换码每行一个，优惠码可只填一个并按上限复用',
      preparedCodes: '已准备 {count} 个码',
      codesShortage: '余额兑换码还缺 {count} 个；如果使用优惠码，可只填 1 个并按上限复用',
      codesReady: '补偿码已填写',
      allUsersCodesHint: '全员模式可填 1 个优惠码，或准备足量余额兑换码；后台会校验金额、状态和优惠码上限。',
      reset: '重置草稿',
      previewSend: '发送站内信',
      sending: '发送中...',
      previewTitle: '站内信预览',
      previewSubtitle: '按用户实际收到的内容格式展示。',
      preparedRedeemCodes: '引用补偿码',
      redeemCodePlaceholder: '补偿码',
      defaultSubject: '服务补偿通知',
      defaultContent: '您好，感谢您的理解与支持。本次通知内容将在这里展示。',
      fromOfficial: '发件人：官方',
      toPreview: '收件人：{recipient}',
      allUsers: '全部用户',
      inactiveUsersCount: '最近 {days} 天未使用用户',
      selectedUsersCount: '指定 {count} 个用户',
      countUsers: '{count} 个用户',
      previewRecipients: '发送对象',
      previewCompensation: '补偿',
      previewEmail: '邮箱副本',
      emailEnabled: '将发送',
      emailCopyBadge: '发送邮箱副本',
      compensationPreparedSummary: '{amount} 元 / 已准备 {count} 个码',
      selectedRecipients: '已识别收件人',
      moreRecipients: '还有 {count} 个',
      previewBlocked: '请先补全标题、内容、收件人和补偿码',
      sendFailed: '站内信发送失败',
      compensationBlock: '补偿信息\n补偿额度：{amount} 元\n补偿码：{code}\n请复制补偿码前往「兑换」页面使用。',
      compensationCompact: '补偿额度 {amount} 元，补偿码：{code}。请前往「兑换」页面使用。',
      format: {
        block: '分块展示',
        compact: '单行展示'
      },
      ...
      history: {
        title: '历史补偿列表',
        subtitle: '按补偿批次查看已发站内信、补偿额度和补偿码分配情况。',
        addNew: '新增补偿',
        searchPlaceholder: '搜索标题、批次号、邮箱或补偿码',
        statusAll: '全部状态',
        empty: '没有匹配的补偿记录',
        detailTitle: '补偿详情',
        detailSubtitle: '{operator} 创建，批次总额 {amount}',
        audience: '发送范围',
        amount: '补偿额度',
        codes: '补偿码',
        sentResult: '发送结果',
        ...
        failureReason: {
          ...
          SITE_MESSAGE_REDEEM_CODE_SHORTAGE: '缺少补偿码',
          SITE_MESSAGE_REDEEM_CODE_INVALID: '补偿码无效',
          SITE_MESSAGE_REDEEM_CODE_NOT_FOUND: '补偿码不存在',
          SITE_MESSAGE_REDEEM_CODE_LOOKUP_FAILED: '补偿码查询失败',
          SITE_MESSAGE_REDEEM_CODE_TYPE_INVALID: '兑换码不是余额类型',
          SITE_MESSAGE_REDEEM_CODE_STATUS_INVALID: '兑换码不是未使用状态',
          SITE_MESSAGE_REDEEM_CODE_AMOUNT_MISMATCH: '补偿码金额与补偿额度不一致',
          SITE_MESSAGE_PROMO_CODE_INVALID: '优惠码无效',
          PROMO_CODE_EXPIRED: '优惠码已过期',
          PROMO_CODE_DISABLED: '优惠码已停用',
          PROMO_CODE_MAX_USED: '优惠码已达到使用上限',
          PROMO_CODE_ALREADY_USED: '用户已使用过该优惠码',
    ...
    lottery: {
      ...
      create: {
        ...
        earlyBoostParticipantPercent: '前期提升范围（%）',
        earlyBoostParticipantPercentHint: '前多少参与用户提高中奖率，默认前 25%。填 0 可关闭前期提升。',
        rechargeBoostCapPercent: '充值加权上限（%）',
        rechargeBoostCapPercentHint: '历史充值带来的额外中奖率上限，最高 50%。',
        codes: '兑换码',
    ...
    settings: {
      ...
      modelMarket: {
        ...
        autoSync: '自动读取当前模型',
        autoSyncHint: '开启后自动展示公开分组下可调度账号和分组路由中的模型；关闭后可手动勾选展示范围和排序。',
        displayTitle: '页面标题',
        displayTitlePlaceholder: '模型广场',
        displayDescription: '页面说明',
        displayDescriptionPlaceholder: '按平台、分组和计费类型查看当前可用模型。',
        readOnlyPricingHint: '自动读取模型默认按 Token 当前价格展示；也可以在候选模型中手动填写 Token 价格，或切换为按次、按次图片并填写展示单价。图片计费支持 1K / 2K / 4K 分档，未填写的分档不会在前台展示。',
        candidateCount: '候选模型',
        visibleCount: '当前展示',
        currentMode: '同步模式',
        autoSyncMode: '自动同步',
        manualMode: '手动选择',
        autoPreview: '自动同步预览',
        autoPreviewHint: '以下模型来自公开分组下的可调度账号和分组路由，保存后会按当前配置实时展示。',
        manualSelection: '手动选择模型',
        manualSelectionHint: '勾选要展示的模型并设置排序；价格和倍率仍从当前计算价格与分组配置读取。',
        show: '展示',
        sortOrder: '排序',
        platform: '平台',
        model: '模型',
        ...
        groups: '分组 / 倍率',
        billingMode: '计费模式',
        billingModeToken: 'Token 计费',
        billingModePerRequest: '按次计费',
        billingModeImage: '按次图片计费',
        currentPrice: '当前价格',
        inputPrice: '输入',
        outputPrice: '输出',
        cacheReadPrice: '缓存读',
        ...
        noPricing: '未配置价格',
        empty: '暂无可公开展示的模型，请先配置公开分组，并在分组账号或模型路由中提供具体模型。',
        customModels: '自定义模型',
        customModelsHint: '用于补充自动读取不到的模型；价格在这里填写，分组倍率可按选中分组单独覆盖。',
        ...
        rateMultiplier: '倍率',
        save: '保存模型广场',
        customModelRequired: '请先填写自定义模型名称。',
        customGroupRequired: '请先为自定义模型选择分组。',
        saved: '模型广场配置已保存',
        failedToLoad: '模型广场配置加载失败',
        failedToSave: '模型广场配置保存失败',
      },
      features: {
        channelMonitor: {
          title: '渠道监控',
        ...
        userSubscriptions: {
          title: '用户订阅入口',
          description: '控制用户是否可以从侧边栏或直链访问自己的订阅页面。',
          enabled: '显示用户订阅入口',
          ...
          multiplePurchasesEnabled: '允许购买多个有效订阅',
          multiplePurchasesEnabledHint: '开启后，用户可在当前订阅未到期、未耗尽时继续购买订阅套餐。',
        ...
        affiliate: {
          title: '邀请返利',
          description: '老用户邀请新用户注册，新用户充值后老用户按阶梯比例获得返利额度。默认关闭。',
          enabled: '启用邀请返利',
      ...
      site: {
        ...
        ccswitchDefaultModelOpenAI: 'CCSwitch 默认 OpenAI 模型',
        ccswitchDefaultModelOpenAIPlaceholder: '例如：gpt-5.4',
        ccswitchDefaultModelOpenAIHint: '用于导入到 Codex。留空时默认使用 gpt-5.4。',
        ccswitchDefaultModelAnthropic: 'CCSwitch 默认 Claude 模型',
        ccswitchDefaultModelAnthropicPlaceholder: '例如：claude-sonnet-4-5',
        ccswitchDefaultModelAnthropicHint: '用于导入到 Claude Code。留空则不传 model，由客户端自行决定。',
        ccswitchDefaultModelGemini: 'CCSwitch 默认 Gemini 模型',
        ccswitchDefaultModelGeminiPlaceholder: '例如：gemini-2.5-pro',
        ccswitchDefaultModelGeminiHint: '用于导入到 Gemini CLI。留空则不传 model。',
        ccswitchDefaultModelAntigravity: 'CCSwitch 默认 Antigravity Claude 模型',
        ccswitchDefaultModelAntigravityPlaceholder: '例如：claude-sonnet-4-5',
        ccswitchDefaultModelAntigravityHint: '用于 Antigravity 选择 Claude 客户端时的默认模型。留空则不传 model。',
        ccswitchDefaultModelAntigravityGemini: 'CCSwitch 默认 Antigravity Gemini 模型',
        ccswitchDefaultModelAntigravityGeminiPlaceholder: '例如：gemini-2.5-pro',
        ccswitchDefaultModelAntigravityGeminiHint: '用于 Antigravity 选择 Gemini 客户端时的默认模型。留空则不传 model。',
        ...
        supportChat: {
          title: 'AI 客服',
          description: '显示 DocsGPT 客服气泡，并通过 support-gateway 转发浏览器请求。',
          gatewayUrl: 'Support Gateway 地址',
          gatewayUrlPlaceholder: 'https://support-gateway.example.com',
          gatewayUrlHint: '填写公开的 support-gateway 地址；DocsGPT 密钥仍放在 gateway 服务变量里。',
          invalidGatewayUrl: 'Support Gateway 地址必须是完整的 http(s) 地址',
          widgetTitle: '客服标题',
          widgetTitlePlaceholder: 'LumioAPI 客服',
          contactText: '人工联系按钮文案',
          contactTextPlaceholder: '联系人工客服',
          contactUrl: '人工联系按钮 URL',
          contactUrlPlaceholder: 'https://example.com/support',
          invalidContactUrl: '人工联系按钮 URL 必须是完整的 http(s) 地址',
          welcomeMessage: '欢迎语',
          welcomeMessagePlaceholder: '请输入问题，AI 客服会基于文档回答。',
        },
        contactChannels: {
          title: '首页联系渠道',
          description: '配置 QQ 群、飞书群、Telegram 群等入口，首页和控制台技术支持会跳转到这里。',
          addDefaults: '添加默认渠道',
          add: '添加渠道',
          itemLabel: '渠道 #{n}',
          label: '渠道名称',
          ...
          required: '联系渠道需要同时填写名称和链接',
          invalidUrl: '联系渠道链接必须是完整的 http(s) 地址'
        },
        docUrl: '文档链接',
      ...
      betaPolicy: {
        ...
        userIds: '指定用户 ID',
        userIdsHint: '留空表示对全部 LumioAPI 用户生效。指定后仅匹配这些用户的 API Key 请求，且优先于全局规则。',
  ...
  invoice: {
    title: '发票申请',
    description: '提交发票申请并查看历史开票状态',
    totalRecharged: '历史充值金额',
    usedInvoiceAmount: '已申请开票金额',
    remainingAmount: '可申请金额',
    createdOrder: '申请单号',
    applyTitle: '申请开票',
    mailDeliveryHint: '管理员开票完成后，系统会将发票附件发送到填写的邮箱，也可在这里下载。',
    minimumAmountRule: '单次最低开票金额为 {amount}。',
    quotaRule: '申请前系统会校验：历史充值金额 - 已申请/已完成开票金额必须大于等于本次开票金额。',
    taxRule: '开票完成后将按管理员设置比例从账户余额扣除税点，默认 1%，余额不足时可扣为负数。',
    readyRule: '已完成的发票可在历史记录中下载；如邮件发送失败，请联系管理员处理。',
    history: '开票历史',
    submit: '申请',
    download: '下载',
    failedToLoad: '加载发票信息失败',
    formRequired: '请完整填写发票抬头、税号、金额和邮箱',
    amountInvalid: '开票金额必须大于 0',
    amountTooLow: '单次最低开票金额为 {amount}',
    amountExceeded: '开票金额不能超过可申请金额',
    createSuccess: '发票申请已提交',
    createFailed: '提交发票申请失败',
    downloadFailed: '下载发票失败',
    form: {
      title: '发票抬头',
      titlePlaceholder: '请输入发票抬头',
      taxNumber: '发票税号',
      taxNumberPlaceholder: '请输入纳税人识别号',
      amount: '开票金额',
    ...
    errors: {
      INVOICE_NOT_FOUND: '发票申请不存在',
      INVOICE_FEATURE_DISABLED: '当前账号未开通发票申请',
      INVOICE_AMOUNT_TOO_LOW: '单次最低开票金额为 100',
      INVOICE_AMOUNT_EXCEEDED: '开票金额超过可申请金额',
      INVOICE_INVALID_INPUT: '发票申请参数有误',
      INVOICE_INVALID_STATUS: '当前发票状态不允许此操作'
    }
  },
  ...
  payment: {
    ...
    qr: {
      ...
      exactAmountTitle: '必须按下方金额一分不差支付',
      exactAmountWarning: '请不要手动改金额，多付或少付都可能无法自动到账。',
      expiresIn: '剩余支付时间',
      expired: '订单已过期',
    ...
    result: {
      ...
      failed: '支付失败',
      fulfillmentPending: '已支付，到账处理中',
      fulfillmentPendingHint: '款项已确认，系统正在自动重试到账；如仍未到账请联系管理员处理。',
      backToRecharge: '返回充值',
      viewOrders: '查看订单',
    },
    currentBalance: '当前余额',
    balancePay: '余额支付',
    balancePaymentRequired: '所需余额',
    balancePaymentHint: '按当前充值倍率换算，套餐现金价会折算为账户余额扣除。当前倍率：1 CNY = {rate} USD',
    ...
    selectAmountHint: '请选择左侧充值金额后确认支付',
    ...
    errors: {
      ...
      SUBSCRIPTION_DAILY_LIMIT_REACHED: '当前订阅的日额度已用完，请等待下一个重置时间。',
      SUBSCRIPTION_WEEKLY_LIMIT_REACHED: '当前订阅的周额度已用完，请等待下一个重置时间。',
      ...
      WEEKLY_LIMIT_EXCEEDED: '当前周额度已达上限，请等待下一个重置时间。',
      ...
      MANUAL_REASON_REQUIRED: '请填写补单原因',
      MANUAL_REASON_TOO_LONG: '补单原因不能超过 500 个字符',
    ...
    planCard: {
      ...
      validity: '有效期',
      scope: '范围',
      scopeAllAvailable: '全部可用分组',
      scopeSelectedGroups: '{count} 个指定分组',
      scopePlatforms: '指定平台',
      dailyLimit: '日限额',
      weeklyLimit: '周限额',
      monthlyLimit: '月限额',
    ...
    admin: {
      ...
      retrySuccess: '重试成功',
      manualComplete: '补单',
      manualCompleteTitle: '手动补单',
      manualCompleteHint: '确认订单 {orderNo} 已在线下实际收款 ¥{amount} 后再补单。成功后会视为支付成功并发放权益。',
      manualCompleteReason: '补单原因',
      manualCompleteReasonPlaceholder: '例如：支付宝账单已到账，回调超过过期宽限期',
      manualCompleteReasonHint: '原因会写入订单操作日志，便于后续审计。',
      manualCompleteReasonRequired: '请填写补单原因',
      confirmManualComplete: '确认补单',
      manualCompleteSuccess: '补单成功',
      approveRefund: '批准退款',
      retryRefund: '重试退款',
      ...
      purchaseNotice: '购买须知',
      purchaseNoticePlaceholder: '输入该套餐的购买须知，支持多行。',
      createPlan: '创建套餐',
      editPlan: '编辑套餐',
      deletePlan: '删除套餐',
      ...
      quotaRequired: '额度池必须大于 0',
      validityDaysRequired: '有效期天数必须在 1 到 30 之间',
      creditPoolSettings: '额度池设置',
      creditPoolHint: '套餐将提供可在所选范围内共享的 USD 额度池。',
      quotaUsd: '额度池（USD）',
      scopeType: '适用范围',
      scopeAllAvailableGroups: '全部可用订阅分组',
      scopeSelectedGroups: '指定分组',
      scopeSelectedPlatforms: '指定平台',
      selectedGroups: '已选分组',
      selectedPlatforms: '已选平台',
      scopeSelectionRequired: '请至少选择一个适用范围',
      groupMissing: '缺失',
      groupInfo: '分组信息',
      platform: '平台',
  ...
  supportChat: {
    title: 'LumioAPI 客服',
    subtitle: 'AI 客服助手',
    welcome: '你好，我会优先基于 LumioAPI 文档回答。涉及账户、付款或无法确认的问题，请联系官方支持。',
    open: '打开客服',
    close: '关闭客服',
    clear: '清空会话',
    send: '发送',

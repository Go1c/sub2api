export default {
  ...
  admin: {
    ...
    settings: {
      ...
      publicPricing: {
        title: '首页模型定价',
        description: '配置主页定价表展示的模型、官方美元价格和渠道倍率。',
        autoCalcHint: '只需填写官方美元价格和渠道计费倍率。系统按 1 美元 = 7 元人民币、用户充值 1 元人民币 = 1 美元额度，自动计算人民币展示价和最终折扣。',
        currency: '币种',
        unit: '单位',
        rateNote: '说明文案',
        rateNotePlaceholder: '例如：充值 ¥1 = $1 账户额度，最终折扣自动计算',
        enabled: '展示',
        model: '模型',
        group: '分组',
        multiplier: '渠道倍率',
        inputPrice: '输入价（自动）',
        outputPrice: '输出价（自动）',
        officialInput: '官方输入（USD）',
        officialOutput: '官方输出（USD）',
        discount: '最终折扣',
        openClaw: 'OpenClaw',
        addRow: '新增模型',
        save: '保存模型定价',
        saved: '模型定价已保存',
        empty: '暂无模型定价',
        failedToLoad: '模型定价加载失败',
        failedToSave: '模型定价保存失败',
        modelRequired: '第 {index} 行模型不能为空',
      },
      features: {
        channelMonitor: {
          title: '渠道监控',

  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamBalance: {
        ...
        loginButton: '获取余额凭据',
        loginLoading: '获取中...',
        loginHint: '支持 NewAPI/Sub2API。密码只用于本次登录换取凭据，不会保存。',
        loginMissingFields: '请填写上游地址、账号和密码',
        loginSuccess: '已获取上游余额凭据',
        loginFailed: '获取上游余额凭据失败',
        newApiAccessToken: '用户 Access Token',
        newApiAccessTokenHint: '可选。可手动填写，或用上方账号密码自动获取；留空则保留已保存的 token。',
        newApiUserId: '上游用户 ID',
        newApiUserIdHint: '可选。NewAPI 需要和用户 Access Token 一起使用；Sub2API 会自动回填。',
        success: '请求成功',
        failed: '请求失败'
      },

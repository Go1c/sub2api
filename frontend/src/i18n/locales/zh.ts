export default {
  ...
  admin: {
    ...
    siteMessageManagement: {
      title: '站内信管理',
      description: '管理员查看历史补偿并发送站内信，可附加已生成的补偿兑换码',
      money: '{amount} 元',
      tabs: {
        history: '历史补偿',
        new: '新增补偿'
      ...
      composeTitle: '发送站内信',
      composeSubtitle: '选择收件范围、填写标题内容，并决定是否附带补偿兑换码。',
      previewBadge: '管理员功能',
      recipientMode: '收件范围',
      mode: {
        selected: '指定邮箱用户',
      ...
      content: '内容',
      contentPlaceholder: '输入站内信正文。开启补偿后，已生成的兑换码会追加在正文末尾。',
      sendEmail: '同时发送到用户邮箱',
      sendEmailHint: '使用已配置的 SMTP 为每位收件人发送一封邮件副本。',
      compensation: '是否发放补偿',
      compensationHint: '补偿码必须先在「兑换码」管理中生成，本站内信只引用已存在的后台记录。',
      compensationAmount: '补偿额度',
      compensationAmountHint: '用于展示和校验，应与已生成的余额兑换码面值一致。',
      compensationFormat: '追加格式',
      generatedCodes: '已生成兑换码',
      openRedeemManagement: '打开兑换码管理',
      generatedCodesPlaceholder: '先到兑换码管理生成余额兑换码，再把码粘贴到这里；每行一个',
      preparedCodes: '已准备 {count} 个兑换码',
      codesShortage: '还缺 {count} 个兑换码',
      codesReady: '兑换码数量充足',
      allUsersCodesHint: '全员模式无法在预览页校验总人数，正式发送前必须确保已生成兑换码数量足够，并由后台再次校验。',
      reset: '重置草稿',
      previewSend: '发送站内信',
      sending: '发送中...',
      previewTitle: '站内信预览',
      previewSubtitle: '按用户实际收到的内容格式展示。',
      preparedRedeemCodes: '引用已生成兑换码',
      redeemCodePlaceholder: '已生成兑换码',
      ...
      previewBlocked: '请先补全标题、内容、收件人和已生成的补偿兑换码',
      sendFailed: '站内信发送失败',
      compensationBlock: '补偿信息\n补偿额度：{amount} 元\n兑换码：{code}\n请复制兑换码前往「兑换」页面使用。',
      compensationCompact: '补偿额度 {amount} 元，兑换码：{code}。请前往「兑换」页面使用。',
      format: {
        block: '分块展示',
        compact: '单行展示'
      },
      ...
      history: {
        title: '历史补偿列表',
        subtitle: '按补偿批次查看已发站内信、补偿额度和兑换码分配情况。',
        addNew: '新增补偿',
        searchPlaceholder: '搜索标题、批次号、邮箱或兑换码',
        statusAll: '全部状态',
        empty: '没有匹配的补偿记录',
        detailTitle: '补偿详情',
        ...
        failureReason: {
          ...
          SITE_MESSAGE_REDEEM_CODE_NOT_FOUND: '兑换码不存在',
          SITE_MESSAGE_REDEEM_CODE_LOOKUP_FAILED: '兑换码查询失败',
          SITE_MESSAGE_REDEEM_CODE_TYPE_INVALID: '兑换码不是余额类型',
          SITE_MESSAGE_REDEEM_CODE_STATUS_INVALID: '兑换码不是未使用状态',
          SITE_MESSAGE_REDEEM_CODE_AMOUNT_MISMATCH: '兑换码金额与补偿额度不一致',

export default {
  ...
  admin: {
    ...
    siteMessageManagement: {
      ...
      previewBlocked: 'Complete recipients and prepared compensation codes first',
      previewOnlyToast: 'This is a preview and no real message was sent',
      ...
      history: {
        ...
        resend: 'Send again',
        addedToast: 'Added to compensation history preview',

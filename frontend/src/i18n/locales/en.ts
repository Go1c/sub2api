export default {
  ...
  admin: {
    ...
    siteMessageManagement: {
      ...
      description: 'Review compensation history and send admin site messages with prepared redeem codes',
      money: '${amount}',
      tabs: {
      ...
      content: 'Content',
      contentPlaceholder: 'Write the site message body. When compensation is enabled, prepared redeem codes are appended at the end.',
      sendEmail: 'Also send to user email',
      sendEmailHint: 'Send one email copy to each recipient with the configured SMTP service.',
      compensation: 'Send compensation',
      compensationHint: 'Compensation codes must be generated first in Redeem Codes. This message only references existing backend records.',
      compensationAmount: 'Compensation amount',
      compensationAmountHint: 'Display and validation amount. It should match the prepared balance redeem code value.',
      compensationFormat: 'Append format',
      generatedCodes: 'Prepared redeem codes',
      openRedeemManagement: 'Open Redeem Codes',
      generatedCodesPlaceholder: 'Generate balance redeem codes in Redeem Codes first, then paste them here. One code per line.',
      preparedCodes: '{count} codes prepared',
      codesShortage: '{count} more codes needed',
      codesReady: 'Enough codes prepared',
      allUsersCodesHint: 'All-user mode cannot validate the total recipient count in preview. Before real sending, enough redeem codes must exist and the backend should validate the count again.',
      reset: 'Reset draft',
      previewSend: 'Send site message',
      sending: 'Sending...',
      previewTitle: 'Message Preview',
      previewSubtitle: 'Shows the format users will receive.',
      preparedRedeemCodes: 'Using prepared redeem codes',
      redeemCodePlaceholder: 'prepared redeem code',
      ...
      compensationCompact: 'Compensation amount ${amount}, redeem code: {code}. Use it on the Redeem page.',
      format: {
        block: 'Block',
        compact: 'Single line'
      },
      ...
      history: {
        ...
        subtitle: 'Review sent site messages, compensation amounts, and redeem code assignment by batch.',
        addNew: 'New Compensation',
        searchPlaceholder: 'Search subject, batch ID, email, or redeem code',
        ...
        missingCode: 'Missing redeem code',
        summary: {
          batches: 'Batches',
          amount: 'Total compensation',
          codes: 'Redeem code records'
        },
        status: {
          sent: 'Sent',
        ...
        failureReason: {
          ...
          SITE_MESSAGE_REDEEM_CODE_NOT_FOUND: 'Redeem code not found',
          SITE_MESSAGE_REDEEM_CODE_LOOKUP_FAILED: 'Redeem code lookup failed',
          ...
          SITE_MESSAGE_REDEEM_CODE_AMOUNT_MISMATCH: 'Redeem code amount does not match compensation amount',

export default {
  ...
  nav: {
    ...
    siteMessageManagement: 'Site Message Management',
    invoices: 'Invoices',
    apiKeys: 'API Keys',
    ...
    subscriptionWasteStats: 'Waste Stats',
    accounts: 'Accounts',
    proxies: 'Proxies',
  ...
  usage: {
    ...
    deductionModeBalance: 'Balance',
    deductionModeSubscription: 'Subscription',
    deductionModeMixed: 'Mixed',
    tokens: 'Tokens',
    cost: 'Cost',
  ...
  profile: {
    ...
    webhookNotify: {
      title: 'Webhook',
      description: 'Send notifications to your webhook URL when balance is low, or when you receive a site message or announcement (no browser required)',
      enabled: 'Enable Webhook',
      webhookUrl: 'Webhook URL',
      webhookUrlHint: 'HTTPS only',
      webhookUrlPlaceholder: 'https://example.com/hooks/xxx',
      balanceAlert: 'Notify when balance falls below threshold',
      balanceAlertHint: 'Sent when balance first drops below the threshold',
      alwaysOnWithMaster: 'On with master switch',
      ...
      siteMessageHint: 'Sent when a new inbox message arrives',
      announcement: 'Notify on new announcements',
      announcementHint: 'Sent when a new visible announcement is available',
      test: 'Send test',
      testing: 'Sending…',
  ...
  admin: {
    ...
    dashboard: {
      ...
      balanceRankingTop20: 'Balance Ranking Top 20',
      balanceUserCount: '{count} users',
      balanceUnit: 'Unit: USD account credit',
      rank: 'Rank',
      todayRequests: 'Today Requests',
    ...
    users: {
      ...
      siteMessage: {
        action: 'Send Site Message',
        title: 'Send Site Message',
        subject: 'Subject',
        content: 'Content',
        sendEmail: 'Also send to user email',
        sendEmailHint: 'Send an email copy with the configured SMTP service',
        send: 'Send',
        sending: 'Sending...',
        sent: 'Site message sent',
        failed: 'Failed to send site message'
      },
    ...
    channelMonitor: {
      ...
      form: {
        ...
        checkModeIQHint: 'Runs the original arithmetic probe, then a separate candy-quiz request for IQ',
        iqQuestion: 'Quiz question',
        iqQuestionHint: 'IQ uses this quiz on its own request; it does not reuse the probe. Matching can be fuzzy',
    ...
    accounts: {
      ...
      ipGroupHint: 'Selecting a group changes the egress IP only. The same conversation stays on the first IP.',
      ipGroupConcurrency: 'per-IP concurrency {count}',
      concurrency: 'Concurrency',
    ...
    proxies: {
      ...
      ipGroupMembers: 'Member proxies',
      ipGroupCreate: 'Create IP group',
      ipGroupEdit: 'Edit IP group',
      ipGroupDelete: 'Delete IP group',
      ipGroupDeleteConfirm: "Delete IP group '{name}'?",
      ipGroupSaved: 'IP group saved',
      ipGroupDeleted: 'IP group deleted',
      ipGroupEmpty: 'No IP groups yet',
      ipGroupInUse: 'Accounts still use this IP group. Unbind them first.',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          enabled: 'Enable Site Messages',
          enabledHint: 'When off, the user entry is hidden and site-message APIs report the feature as disabled.',
          dailyLimit: 'Daily send limit for non-admins',
      ...
      gatewayForwarding: {
        ...
        grokCrossClientMapHint: 'Default on so Codex and Claude clients keep working against Grok groups. Disable to stop silent cross-vendor rewrites.',
        ...
        claudeOAuthSystemPromptBlocksPlaceholder: 'Leave empty to use the built-in 3 blocks. Supports a JSON array or a JSON object with a blocks field.',
      ...
      site: {
        ...
        contactChannels: {
          title: 'Home Contact Channels',
          description: 'Configure QQ, Feishu, Telegram, or other support links for the home support area and console support nav.',
          addDefaults: 'Add Default Channels',
          add: 'Add Channel',
          itemLabel: 'Channel #{n}',
          label: 'Channel Name',
          labelPlaceholder: 'e.g., Telegram Group',
          url: 'Target URL',
          urlPlaceholder: 'https://example.com/invite',
          required: 'Contact channels require both a name and a URL',
          invalidUrl: 'Contact channel URL must be an absolute http(s) URL'
        },
        ccswitchDefaultModelOpenAI: 'CCSwitch Default OpenAI Model',
        ccswitchDefaultModelOpenAIPlaceholder: 'e.g. gpt-5.4',
        ccswitchDefaultModelOpenAIHint: 'Used for Codex imports. Defaults to gpt-5.4 when empty.',
        ccswitchDefaultModelAnthropic: 'CCSwitch Default Claude Model',
        ccswitchDefaultModelAnthropicPlaceholder: 'e.g. claude-sonnet-4-5',
        ccswitchDefaultModelAnthropicHint: 'Used for Claude Code imports. Leave empty to omit model and let the client decide.',
        ccswitchDefaultModelGemini: 'CCSwitch Default Gemini Model',
        ccswitchDefaultModelGeminiPlaceholder: 'e.g. gemini-2.5-pro',
        ccswitchDefaultModelGeminiHint: 'Used for Gemini CLI imports. Leave empty to omit model.',
        ccswitchDefaultModelAntigravity: 'CCSwitch Default Antigravity Claude Model',
        ccswitchDefaultModelAntigravityPlaceholder: 'e.g. claude-sonnet-4-5',
        ccswitchDefaultModelAntigravityHint: 'Used when importing Antigravity with the Claude client. Leave empty to omit model.',
        ccswitchDefaultModelAntigravityGemini: 'CCSwitch Default Antigravity Gemini Model',
        ccswitchDefaultModelAntigravityGeminiPlaceholder: 'e.g. gemini-2.5-pro',
        ccswitchDefaultModelAntigravityGeminiHint: 'Used when importing Antigravity with the Gemini client. Leave empty to omit model.',
        ...
        supportChat: {
          ...
          description: 'Show the DocsGPT support chat bubble and route browser requests through support-gateway.',
          gatewayUrl: 'Support Gateway URL',
          gatewayUrlPlaceholder: 'https://support-gateway.example.com',
          gatewayUrlHint: 'Public support-gateway URL. DocsGPT keys stay in the gateway service variables.',
          invalidGatewayUrl: 'Support gateway URL must be an absolute http(s) URL',
          widgetTitle: 'Widget Title',
          widgetTitlePlaceholder: 'LumioAPI Support',
          contactText: 'Contact Button Text',
          contactTextPlaceholder: 'Contact human support',
          contactUrl: 'Contact Button URL',
          contactUrlPlaceholder: 'https://example.com/support',
          invalidContactUrl: 'Contact button URL must be an absolute http(s) URL',
          welcomeMessage: 'Welcome Message',
          welcomeMessagePlaceholder: 'Ask a question and the AI assistant will answer from the docs.',
        },
},
      purchase: {
      ...
      modelMarket: {
        ...
        autoSyncHint: 'When enabled, models from schedulable accounts and group routing under public groups are shown. Turn it off to choose models and ordering manually.',
        ...
        readOnlyPricingHint: 'Auto-read models default to current token pricing. You can manually enter token prices, or switch candidate models to per-request, per-image, or per-video billing and enter displayed unit prices. Image billing supports optional 1K / 2K / 4K tiers, and video billing supports optional 480P / 720P / 1080P tiers; empty tiers are not shown publicly. The admin form has no cache-read/write fields; use Restore automatic price to drop a saved overlay. Clearing input/output alone will not remove cached overlay rates.',
        candidateCount: 'Candidates',
        visibleCount: 'Visible now',
        currentMode: 'Mode',
        autoSyncMode: 'Auto sync',
        manualMode: 'Manual selection',
        autoPreview: 'Auto-sync preview',
        autoPreviewHint: 'These models come from schedulable accounts and group routing under public groups and will track current configuration after saving.',
        manualSelection: 'Manual model selection',
        manualSelectionHint: 'Select models and set ordering. Prices and multipliers still come from current billing calculations and group settings.',
        show: 'Show',
        sortOrder: 'Sort',
        platform: 'Platform',
        model: 'Model',
        channels: 'Source',
        groups: 'Groups / multiplier',
        billingMode: 'Billing mode',
        billingModeToken: 'Token billing',
        billingModePerRequest: 'Per-request billing',
        billingModeImage: 'Per-image billing',
        billingModeVideo: 'Per-video billing',
        ...
        empty: 'No publicly visible models yet. Configure public groups, then provide concrete models through group accounts or model routing.',
        customModels: 'Custom models',
        customModelsHint: 'Add models that cannot be read automatically. Prices are entered here, and the selected group multiplier can be overridden.',
        addCustomModel: 'Add custom model',
        noCustomModels: 'No custom models yet.',
        customModelPlaceholder: 'For example gpt-5.4-custom',
        group: 'Group',
        selectGroup: 'Select group',
        rateMultiplier: 'Multiplier',
        restoreAutoPrice: 'Restore automatic price',
        save: 'Save model market',
        customModelRequired: 'Enter a custom model name first.',
        customGroupRequired: 'Select a group for the custom model first.',
        saved: 'Model market settings saved',
        failedToLoad: 'Failed to load model market settings',
        failedToSave: 'Failed to save model market settings',
      },
},
    ...
    lottery: {
      ...
      create: {
        ...
        description: 'Define prizes and redemption codes. The campaign opens as a popup when users log in. If prizes cover every participant slot, everyone wins.',
        name: 'Campaign Name',
        ...
        earlyBoostParticipantPercent: 'Early Boost Range (%)',
        earlyBoostParticipantPercentHint: 'Boost odds for the first N% of participants. Default is 25%; set 0 to disable.',
        rechargeBoostCapPercent: 'Recharge Boost Cap (%)',
        rechargeBoostCapPercentHint: 'Maximum extra win rate from historical recharge amount. Max 50%.',
        promoSection: 'Follow prompt (optional)',
        promoSectionHint: 'The same copy and image appear before the spin, on winning results, and in the winning site message. The image must be a public HTTPS URL from the backup S3 / R2 bucket, not a presigned attachment link.',
        promoText: 'Prompt copy',
        promoTextPlaceholder: 'Follow the official account for more campaigns',
        promoImageUrl: 'Poster HTTPS URL',
        promoImageUrlPlaceholder: 'https://pub-xxxx.r2.dev/lottery/wechat-qr.png',
        promoImageUrlHint: 'Upload the image to the existing backup bucket (suggested key: lottery/wechat-qr.png), then paste the public HTTPS URL. Do not use the S3 API endpoint or a presigned URL with Content-Disposition: attachment.',
        promoPreviewEmpty: 'Paste an HTTPS URL to preview here',
        guaranteedWinHint: 'When prizes are at least as many as participant slots, every participant wins (for example 100 people and 100 prizes = 100% win rate).',
        wheelNote: 'The user-facing wheel is always 8 slices, independent of prize count.',
        ...
        uxPreview: 'Full experience preview',
        previewTitle: 'Lottery Preview',
        previewSubtitle: 'Admin preview — no participant impact',
        previewPromoText: 'Follow our WeChat official account for more codes and campaign updates',
        saved: '✓ Published. Switch to "History" to verify.',
        invalid: 'Please check required fields and code count.',
        invalidPromoImage: 'The poster URL must be a public https:// link.',
    ...
    // siteMessageManagement
    siteMessageManagement: {
      title: 'Site Message Management',
      description: 'Review compensation history and send admin site messages with compensation codes',
      money: '${amount}',
      tabs: {
        history: 'Compensation History',
        new: 'New Compensation'
      },
      composeTitle: 'Send Site Message',
      composeSubtitle: 'Choose recipients, write the message, and optionally attach prepared compensation codes.',
      previewBadge: 'Admin tool',
      recipientMode: 'Recipients',
      mode: {
        selected: 'Selected email users',
        selectedDescription: 'Paste an email list and send only to those users.',
        all: 'All users',
        allDescription: 'Send to every registered user. Review carefully before real sending.'
      },
      recipientList: 'Email list',
      clear: 'Clear',
      recipientPlaceholder: 'One email per line, or separate with commas, spaces, or semicolons',
      parsedRecipients: '{count} emails parsed',
      invalidRecipients: '{count} invalid entries',
      recipientFilter: 'All-user filter',
      filter: {
        all: 'All active users',
        allDescription: 'Send to every registered user with active status.',
        inactive: 'Recently inactive users',
        inactiveDescription: 'Only send to active users with no API usage records in the last N days.'
      },
      inactiveDays: 'Inactive days',
      inactiveDaysHint: 'Based on usage logs. Users who never used the service are included.',
      subject: 'Subject',
      subjectPlaceholder: 'Example: service maintenance compensation notice',
      content: 'Content',
      contentPlaceholder: 'Write the site message body. When compensation is enabled, compensation codes are appended at the end.',
      sendEmail: 'Also send to user email',
      sendEmailHint: 'Send one email copy to each recipient with the configured SMTP service.',
      compensation: 'Send compensation',
      compensationHint: 'Use balance redeem codes from Redeem Codes or promo codes from Promo Codes. Balance is added when the user redeems the code.',
      compensationAmount: 'Compensation amount',
      compensationAmountHint: 'Display and validation amount. It should match the balance redeem code value or promo bonus amount.',
      compensationFormat: 'Append format',
      generatedCodes: 'Compensation codes',
      openRedeemManagement: 'Open Redeem Codes',
      openPromoManagement: 'Open Promo Codes',
      generatedCodesPlaceholder: 'Paste balance redeem codes or a promo code. Redeem codes need one per line; one promo code can be reused up to its limit.',
      preparedCodes: '{count} codes prepared',
      codesShortage: '{count} more balance redeem codes needed. For a promo code, one code can be reused up to its limit.',
      codesReady: 'Compensation code entered',
      allUsersCodesHint: 'All-user mode can use one promo code or enough balance redeem codes. The backend validates amount, status, and promo usage limits.',
      reset: 'Reset draft',
      previewSend: 'Send site message',
      sending: 'Sending...',
      previewTitle: 'Message Preview',
      previewSubtitle: 'Shows the format users will receive.',
      preparedRedeemCodes: 'Using compensation codes',
      redeemCodePlaceholder: 'compensation code',
      defaultSubject: 'Service Compensation Notice',
      defaultContent: 'Hello, thank you for your understanding and support. The message content will appear here.',
      fromOfficial: 'From: Official',
      toPreview: 'To: {recipient}',
      allUsers: 'All users',
      inactiveUsersCount: 'Users inactive for {days} days',
      selectedUsersCount: '{count} selected users',
      countUsers: '{count} users',
      previewRecipients: 'Recipients',
      previewCompensation: 'Compensation',
      previewEmail: 'Email copy',
      emailEnabled: 'Will send',
      emailCopyBadge: 'Email copy',
      compensationPreparedSummary: '${amount} / {count} prepared code(s)',
      selectedRecipients: 'Parsed recipients',
      moreRecipients: '{count} more',
      previewBlocked: 'Complete subject, content, recipients, and prepared compensation codes first',
      sendFailed: 'Failed to send site message',
      compensationBlock: 'Compensation\nAmount: ${amount}\nCompensation code: {code}\nCopy the code and use it on the Redeem page.',
      compensationCompact: 'Compensation amount ${amount}, compensation code: {code}. Use it on the Redeem page.',
      format: {
        block: 'Block',
        compact: 'Single line'
      },
      ...
      history: {
        ...
        subtitle: 'Review sent site messages, compensation amounts, and compensation code assignment by batch.',
        addNew: 'New Compensation',
        searchPlaceholder: 'Search subject, batch ID, email, or compensation code',
        statusAll: 'All statuses',
        empty: 'No matching compensation records',
        detailTitle: 'Compensation Detail',
        detailSubtitle: 'Created by {operator}, batch total {amount}',
        audience: 'Audience',
        amount: 'Amount',
        ...
        sentAt: 'Sent at: {time}',
        codeAssignments: 'Compensation code assignments',
        noCodes: 'This batch did not record compensation codes',
        failures: 'Failures',
        ...
        loadFailed: 'Failed to load compensation history',
        ...
        allUsersBatch: 'All-user batch {index}',
        missingCode: 'Missing compensation code',
        summary: {
          batches: 'Batches',
          amount: 'Total compensation',
          codes: 'Compensation code records'
        },
        status: {
          sent: 'Sent',
        ...
        failureReason: {
          ...
          SITE_MESSAGE_REDEEM_CODE_SHORTAGE: 'Missing compensation code',
          SITE_MESSAGE_REDEEM_CODE_INVALID: 'Invalid compensation code',
          SITE_MESSAGE_REDEEM_CODE_NOT_FOUND: 'Compensation code not found',
          SITE_MESSAGE_REDEEM_CODE_LOOKUP_FAILED: 'Compensation code lookup failed',
          SITE_MESSAGE_REDEEM_CODE_TYPE_INVALID: 'Redeem code is not a balance code',
          SITE_MESSAGE_REDEEM_CODE_STATUS_INVALID: 'Redeem code is not unused',
          SITE_MESSAGE_REDEEM_CODE_AMOUNT_MISMATCH: 'Compensation code amount does not match compensation amount',
          SITE_MESSAGE_PROMO_CODE_INVALID: 'Invalid promo code',
          PROMO_CODE_EXPIRED: 'Promo code has expired',
          PROMO_CODE_DISABLED: 'Promo code is disabled',
          PROMO_CODE_MAX_USED: 'Promo code has reached its usage limit',
          PROMO_CODE_ALREADY_USED: 'User has already used this promo code',
  ...
  payment: {
    ...
    status: {
          ...
          fulfillment_failed: 'Paid, fulfillment pending'
        },
    qr: {
          ...
          exactAmountTitle: 'Pay the exact amount shown below',
          exactAmountWarning: 'Do not edit the amount. Overpaying or underpaying may prevent automatic credit.'
        },
    orders: {
          title: 'My Orders',
          empty: 'No orders yet',
    ...
    result: {
          ...
          fulfillmentPending: 'Paid, fulfillment pending',
          fulfillmentPendingHint: 'Payment is confirmed. Credit or subscription delivery is being retried; contact support if it does not arrive.'
        },
    currentBalance: 'Current Balance',
    ...
    errors: {
          ...
          SUBSCRIPTION_DAILY_LIMIT_REACHED: 'Your subscription daily limit has been reached. Please wait for the next reset.',
          SUBSCRIPTION_WEEKLY_LIMIT_REACHED: 'Your subscription weekly limit has been reached. Please wait for the next reset.',
          INSUFFICIENT_BALANCE: 'Insufficient account balance.',
          WEEKLY_LIMIT_EXCEEDED: 'Weekly limit reached. Please wait for the next reset.',
          MANUAL_REASON_REQUIRED: 'Please enter a supplement reason.',
          MANUAL_REASON_TOO_LONG: 'Supplement reason cannot exceed 500 characters.'
        },
    ...
    planCard: {
          ...
          validity: 'Validity',
          scope: 'Scope',
          scopeAllAvailable: 'All available groups',
          scopeSelectedGroups: '{count} selected groups',
          scopePlatforms: 'Selected platforms'
        },
    days: 'days',
    months: 'months',
    years: 'years',
    ...
    admin: {
          ...
          week: 'week',
          month: 'month',
          manualComplete: 'Supplement',
          manualCompleteTitle: 'Manual Order Supplement',
          manualCompleteHint: 'Only supplement order {orderNo} after confirming the provider has collected ¥{amount}. This will treat the order as paid and fulfill it.',
          manualCompleteReason: 'Supplement Reason',
          manualCompleteReasonPlaceholder: 'Example: Alipay payment received, callback arrived after expiry grace period',
          manualCompleteReasonHint: 'The reason is saved in the order audit log.',
          manualCompleteReasonRequired: 'Please enter a supplement reason',
          confirmManualComplete: 'Confirm Supplement',
          manualCompleteSuccess: 'Order supplemented successfully',
          purchaseNotice: 'Purchase Notice',
          purchaseNoticePlaceholder: 'Enter plan-specific purchase notes. Multi-line text is supported.',
          syncPlanLimits: 'Sync Limits',
          syncPlanLimitsConfirm: 'Sync Limits',
          syncPlanLimitsPreviewMessage: 'Sync the current plan daily limit {dailyLimit} and weekly limit {weeklyLimit} to purchased subscriptions. {matched} active subscriptions match; {changed} will be updated. Total quota, validity, scope, and usage stay unchanged.',
          syncPlanLimitsSuccess: 'Synced daily/weekly limits for {updated} subscriptions',
          noLimit: 'No limit',
          providerMapay: 'Mapay',
          monthPickerTitle: 'View by month',
          quotaRequired: 'Credit quota must be greater than 0',
          creditPoolSettings: 'Credit Pool Settings',
          creditPoolHint: 'Plans now grant a shared USD credit pool across the selected scope.',
          quotaUsd: 'Credit Quota (USD)',
          scopeType: 'Scope',
          scopeAllAvailableGroups: 'All available subscription groups',
          scopeSelectedGroups: 'Selected groups',
          scopeSelectedPlatforms: 'Selected platforms',
          selectedGroups: 'Selected Groups',
          selectedPlatforms: 'Selected Platforms',
          scopeSelectionRequired: 'Please select at least one scope target'
        },
    balancePay: 'Pay with Balance',
    balancePaymentRequired: 'Required Balance',
    balancePaymentHint: 'The cash price is converted to account balance using the current recharge rate. Current rate: 1 CNY = {rate} USD',
    ...
    selectAmountHint: 'Select an amount on the left before confirming payment',
    purchaseNotice: 'Purchase Notice',
    weeks: 'weeks'
  },
  ...
  siteMessages: {
    title: 'Site Messages',
    description: 'Read and send site messages',
    inbox: 'Inbox',
    sent: 'Sent',
    compose: 'Compose',
    send: 'Send',
    ...
    recipient: 'Recipient',
    recipientPlaceholder: 'Email or user ID',
    subject: 'Subject',
    content: 'Content',
    from: 'From',
    to: 'To',
    adminSender: 'Official',
    emptyInbox: 'No received messages',
    emptySent: 'No sent messages',
    emptyDetail: 'Select a message',
    sentSuccess: 'Message sent',
    replySent: 'Reply sent',
    failedToLoad: 'Failed to load site messages',
    failedToSend: 'Failed to send site message',
  ...
  invoice: {
    ...
    submit: 'Submit',
    fillLastSuccess: 'Fill from last success',
    fillLastSuccessDone: 'Filled title, tax number, and email from your last completed invoice',
    noCompletedHistory: 'No completed invoice history to fill from',
    download: 'Download',
  ...
  stepUp: {
    ...
    verifyFailed: 'Verification failed, please try again',
    notEnabled: 'This operation requires two-factor authentication. Enable TOTP in your profile first.',

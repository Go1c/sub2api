  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamBalance: {
        ...
        loginHint: 'Supports NewAPI/Sub2API. The password is used only for this login request and is not saved.',
        ...
        newApiAccessTokenHint: 'Optional. Fill manually or fetch with account/password above; leave empty to keep the existing token.',
        newApiUserId: 'Upstream User ID',
        newApiUserIdHint: 'Optional. NewAPI requires this with the user access token; Sub2API is filled automatically.',

export default {
  ...
  admin: {
    ...
    settings: {
      ...
      modelMarket: {
        title: 'Model Market',
        description: 'Configure which models appear on the public /models page. Prices, billing modes, and group multipliers are read from current channel settings.',
        enabled: 'Enable model market',
        enabledHint: 'When disabled, the public model market remains reachable but shows no models.',
        autoSync: 'Read current channels automatically',
        autoSyncHint: 'When enabled, all active channel models from public groups are shown. Turn it off to choose models and ordering manually.',
        ...
        readOnlyPricingHint: 'Prices are not configured here. Model prices come from channel pricing, group multipliers come from group settings, and private/exclusive groups are not exposed publicly.',
        ...
        autoPreviewHint: 'These models come from active channels and public groups and will track live channel changes after saving.',
        manualSelection: 'Manual model selection',
        manualSelectionHint: 'Select models and set ordering. Prices and multipliers still come from live channel and group settings.',
        show: 'Show',
        sortOrder: 'Sort',
        platform: 'Platform',
        model: 'Model',
        ...
        empty: 'No publicly visible models yet. Configure active channels, model pricing, and public groups first.',
        customModels: 'Custom models',
        customModelsHint: 'Add models that cannot be derived from channels. Prices are entered here, and the selected group multiplier can be overridden.',

export default {
  ...
  admin: {
    ...
    settings: {
      ...
      publicPricing: {
        title: 'Homepage Model Pricing',
        description: 'Configure the models, official USD prices, and channel multipliers shown on the homepage pricing table.',
        autoCalcHint: 'Enter only the official USD price and channel billing multiplier. The system uses 1 USD = ¥7 and recharge ¥1 = $1 account credit to calculate CNY display prices and the final discount.',
        currency: 'Currency',
        unit: 'Unit',
        rateNote: 'Note',
        rateNotePlaceholder: 'Example: Recharge ¥1 = $1 account credit; final discount is calculated automatically',
        enabled: 'Shown',
        model: 'Model',
        group: 'Group',
        multiplier: 'Channel multiplier',
        inputPrice: 'Input (auto)',
        outputPrice: 'Output (auto)',
        officialInput: 'Official input (USD)',
        officialOutput: 'Official output (USD)',
        discount: 'Final discount',
        openClaw: 'OpenClaw',
        addRow: 'Add model',
        save: 'Save model pricing',
        saved: 'Model pricing saved',
        empty: 'No model pricing rows',
        failedToLoad: 'Failed to load model pricing',
        failedToSave: 'Failed to save model pricing',
        modelRequired: 'Model is required on row {index}',
      },
      features: {
        channelMonitor: {
          title: 'Channel Monitor',

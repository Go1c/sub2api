export default {
  ...
  redeem: {
    title: 'Redeem Code',
    description: 'Enter a redeem code or promo code to add balance, increase concurrency, or claim bonus balance',
    currentBalance: 'Current Balance',
    concurrency: 'Concurrency',
    requests: 'requests',
    redeemCodeLabel: 'Redeem / Promo Code',
    redeemCodePlaceholder: 'Enter a redeem or promo code',
    redeemCodeHint: 'Redeem codes are case-sensitive; promo codes follow their usage limit',
    redeeming: 'Redeeming...',
    ...
    aboutCodes: 'About Codes',
    codeRule1: 'Redeem codes can only be used once; promo codes follow the configured usage limit',
    codeRule2: 'Redeem codes may add balance, increase concurrency, or grant trial access; promo codes add bonus balance',
    ...
    failedToRedeem: 'Failed to redeem code. Please check the redeem or promo code and try again.',
    subscriptionRefreshFailed: 'Redeemed successfully, but failed to refresh subscription status.',
    pleaseEnterCode: 'Please enter a redeem or promo code'
  },
  ...
  admin: {
    ...
    riskControl: {
      ...
      scoreThreshold: 'Hit Score Threshold',
      scoreThresholdPlaceholder: 'Blank uses default category thresholds',
      scoreThresholdHint: 'Enter 1-100 to treat every category at or above that percentage as a hit. Leave blank to use built-in category thresholds.',
    ...
    accounts: {
      ...
      upstreamBalance: {
        ...
        providerOther: 'Other/Generic',
        loginUsername: 'Upstream Account',
        loginPassword: 'Upstream Password',
        loginPasswordPlaceholder: 'Used for this request only',
        loginButton: 'Get Balance Credentials',
        loginLoading: 'Getting...',
        loginHint: 'Choose the site type first. NewAPI/Sub2API can exchange account/password for balance credentials; other types use generic balance probes.',
        loginMissingFields: 'Please enter upstream URL, account, and password',
        loginUnsupportedProvider: 'Other providers do not support account/password credential fetching. Choose NewAPI or Sub2API.',
        loginSuccess: 'Upstream balance credentials fetched',
        loginFailed: 'Failed to fetch upstream balance credentials',
        newApiAccessToken: 'User Token / Cookie',
        newApiAccessTokenHint: 'Optional. Fill manually or fetch with account/password above; leave empty to keep the existing credential.',
        newApiUserId: 'Upstream User ID',
        newApiUserIdHint: 'Optional. NewAPI requires this with the user credential; Sub2API is filled automatically.',
    ...
    settings: {
      ...
      modelMarket: {
        ...
        readOnlyPricingHint: 'Auto-read models default to current token pricing. You can manually enter token prices, or switch candidate models to per-request or per-image billing and enter displayed unit prices. Image billing supports optional 1K / 2K / 4K tiers; empty tiers are not shown publicly.',
      ...
      features: {
        ...
        affiliate: {
          ...
          description: 'Existing users invite new ones; the inviter earns tiered rebate quota on the invitee’s recharges. Disabled by default.',
      ...
      payment: {
        ...
        field_channelId: 'Default Channel ID',
        field_channelIdAlipay: 'Alipay Channel ID',
        field_channelIdWxpay: 'WeChat Channel ID',
      ...
      betaPolicy: {
        ...
        userIdsHint: 'Leave empty to apply to all LumioAPI users. Specified users match requests from their API keys and take precedence over global rules.',
  ...
  payment: {
    ...
    admin: {
      ...
      validityDaysRequired: 'Validity days must be between 1 and 30',

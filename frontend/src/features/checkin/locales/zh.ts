export default {
  ...
  checkin: {
    ...
    action: { ready: '立即签到', loading: '签到中...', checked: '今日已签到', exhausted: '今日奖池已发完', disabled: '签到未开放', ineligible: '当前不满足门槛' },
    today: { awarded: '今日获得 ${amount}。', exhausted: '连续签到已记录，但今日全站奖池已发完。', replayed: '本次签到已记录，没有重复发放奖励。', ineligible: '当前不满足，累计消费 ${amount} 才可以签到', ineligibleCurrent: '当前累计消费 ${amount}' },
    ...
    sidebar: { ready: '今日奖励待领取', checked: '今日已签到', exhausted: '今日连续签到已记录', ineligible: '当前不满足门槛' },
    settings: {
      ...
      minSpend: '历史消费门槛', minSpendHint: '累计消费（订阅扣费 + 余额扣费）须大于该金额才能签到。填 0 表示不限制。',
